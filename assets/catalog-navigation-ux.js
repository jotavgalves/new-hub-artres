(function(){
  ...
  function installStyle(){
    ...
    style.textContent = '.catalogNavGuide{display:flex;align-items:center;gap:12px;flex-wrap:wrap;margin-top:13px;margin-bottom:2px}.catalogSmartBack{border:1px solid #ffd6e5;background:#fff1f6;color:#d9366b;min-height:40px;padding:0 16px;border-radius:999px;font-family:Montserrat,Arial,sans-serif;font-size:12px;font-weight:900;cursor:pointer;box-shadow:0 8px 18px rgba(239,85,133,.08)}.catalogWhere{display:flex;align-items:center;gap:8px;min-height:40px;padding:0 14px;border:1px solid #eee3e2;background:#fff;border-radius:999px;color:#6c6670;font-size:12px}.catalogWhere span{font-weight:700;color:#8b838a}.catalogWhere b{font-family:Montserrat,Arial,sans-serif;color:#2f2c32;font-size:12.5px}#breadcrumbs,.breadcrumbs{display:flex!important;align-items:center!important;justify-content:flex-start!important;gap:8px!important;flex-wrap:nowrap!important;overflow-x:auto!important;overflow-y:hidden!important;max-width:100%!important;padding-bottom:3px!important;scrollbar-width:none!important;-webkit-overflow-scrolling:touch!important}#breadcrumbs::-webkit-scrollbar,.breadcrumbs::-webkit-scrollbar{display:none!important}#breadcrumbs>*,.breadcrumbs>*{flex:0 0 auto!important}@media(max-width:560px){.catalogNavGuide{align-items:stretch;gap:8px}.catalogSmartBack{width:100%;min-height:42px}.catalogWhere{width:100%;justify-content:center;flex-wrap:wrap;border-radius:18px;padding:9px 12px;text-align:center}.catalogWhere span{width:100%;font-size:10.5px;text-transform:uppercase;letter-spacing:.06em}.catalogWhere b{font-size:12px}#breadcrumbs,.breadcrumbs{gap:6px!important;padding-right:10px!important}}';
