(function(){
  ...
  async function renderClientes(force){
    ...
    shell('Clientes','Clientes vinculados às suas solicitações.','<div id="clientesLista" hidden></div><div id="vendorCustomersList"><p class="hint">Carregando clientes...</p></div>');
    if(loading)return;loading=true;
