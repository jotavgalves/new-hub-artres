...
const ADMIN_PRODUCTS_V2_SCRIPT = '<script id="adminProductsV2Script" src="/assets/admin-products-v2.js?v=2" defer></script>';
const PAINEL_ROMANO_ADMIN_SCRIPT = '<script id="adminPainelRomanoScript" src="/assets/admin-painel-romano.js?v=1" defer></script>';
const RETANGULAR_1X2_ADMIN_SCRIPT = '<script id="adminRetangular1x2Script" src="/assets/admin-retangular-1x2.js?v=3" defer></script>';
...
export async function onRequest(context) {
  ...
  if (!html.includes('/assets/admin-products-v2.js')) scripts.push(ADMIN_PRODUCTS_V2_SCRIPT);
