...
const CACHE_BUST_SCRIPT = '<script src="/assets/catalog-cache-bust.js?v=14"></script>';
...
const DYNAMIC_PRODUCT_COMMERCE_SYNC_SCRIPT = '<script src="/assets/dynamic-product-commerce-sync.js?v=3" defer></script>';
